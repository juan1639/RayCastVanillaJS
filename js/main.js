...
function inicializaArmasJugador()
{
	...
	armas.push(new Arma(canvasAncho / 2, canvasAlto, imgPistola, imgPistolaRecargar, sonidoPistola, 0));
	armas.push(new Arma(canvasAncho / 2, canvasAlto, imgEscopeta, imgEscopetaRecargar, sonidoEscopeta, 1));
}
...
export { dispararRecargar, jugador, buclePrincipal };
